...
public class ModulesMigrationHandler {
    ...
    public Boolean execute(final EnvironmentInfo environmentInfo, final JCRNodeWrapper formNode, RequestContext context, URLGenerator url) throws Exception {

        logger.info("Started modules migration");
